...
**Core Topics:**
- **[Attention Mechanisms](./12_transformers/01_attention_mechanism.md)** - Self-attention fundamentals, QKV framework, multi-head attention, scaled dot-product attention, and attention weight computation
